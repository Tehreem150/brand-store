        ...
        <div className="flex mt-2 mb-4   justify-around">
          ...
          <form className="hidden md:flex">
            <input
              type="text"
              placeholder="Search"
              className="search bg-no-repeat bg-left  h-10 w-[400px] pl-10 text-black bg-[#fcfcfc] border-black border-[1px] rounded-3xl my-4 flex  "
            />
          </form>
          <div className="flex relative  space-x-0 xl:space-x-1 my-3 ">
            <a
