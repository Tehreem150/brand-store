...
const CategoryOuttext = () => {
  ...
  return (
    <div className="mx-auto mt-10 lg:mt-28 h-1/2">
      ...
      <div className=" grid grid-cols-1 gap-0 lg:gap-0 my-10 lg:my-20 mx-16 xl:mx-32 ">
        <Slider {...settings}>
          <div className="w-[324px]  border-gray-900  px-0 ">
...
export default CategoryOuttext;
